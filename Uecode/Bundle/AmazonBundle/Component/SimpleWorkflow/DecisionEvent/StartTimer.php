 ...
 * @see http://docs.aws.amazon.com/amazonswf/latest/apireference/API_StartTimerDecisionAttributes.html
 */
class StartTimer extends DecisionEvent
{
	// optional properties will be commented out.
	// @see http://docs.aws.amazon.com/amazonswf/latest/apireference/API_StartTimerDecisionAttributes.html

	//public $control = ''; // optional
	public $startToFireTimeout = '';
	public $timerId = '';
}
