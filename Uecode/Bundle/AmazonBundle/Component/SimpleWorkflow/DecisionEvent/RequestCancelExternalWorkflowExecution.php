<?php
/**
 * CancelWorkflowExecution decision event
 *
 ...
 * @see http://docs.aws.amazon.com/amazonswf/latest/apireference/API_CancelWorkflowExecutionDecisionAttributes.html
 */
class CancelWorkflowExecution extends DecisionEvent
{
